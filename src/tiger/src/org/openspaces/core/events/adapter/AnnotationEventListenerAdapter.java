...
/**
 * An event listener adapter that uses {@link org.openspaces.events.adapter.SpaceDataEvent} annotation in order
 * to find event listener methods to delegate to.
 *
 * @author kimchy
 */
