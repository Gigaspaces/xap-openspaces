...
/**
 * <p>JiniServiceFactoryBean for Jini environments. The class is made up from various samples found on jini.org
 ...
 *
 * <p>The factoryBean can be configured to do a lookup each time before returning the object type by setting
