 ...
 * configured through {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean}.
...
public @interface EventDrivenRemotingMethod {
    ...
    /**
     * Specifies the globalOneWay behaviour of the annotated method. When the annotation is not set , will default to
     * {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean#setGlobalOneWay(boolean)}.
    ...
    /**
     * Specifies the voidOneWay behaviour of the annotated method. When the annotation is not set , will default to
     * {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean#setVoidOneWay(boolean)}.
     ...
     * When the annotation is not set , will default to
     * {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean#setTimeout(long)}
     ...
     * {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean#setRemoteRoutingHandler(org.openspaces.remoting.RemoteRoutingHandler)}
     */
    String remoteRoutingHandler() default "";

    /**
     * Specifies the class name of a {@link org.openspaces.remoting.RemoteRoutingHandler} to be used for for determining
    ...
    /**
     * Specifies the name in the spring context of a {@link org.openspaces.remoting.RemoteInvocationAspect} to be used when invoking the
     * annotated method. When the annotation is not set , will default to
     * {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean#setRemoteInvocationAspect(org.openspaces.remoting.RemoteInvocationAspect)}
     */
    String remoteInvocationAspect() default "";

    /**
     * Specifies the class name of a {@link org.openspaces.remoting.RemoteInvocationAspect} to be used to be used when invoking the
    ...
    /**
     * Specifies the name in the spring context of a {@link org.openspaces.remoting.MetaArgumentsHandler} to be used when invoking the
     * annotated method. When the annotation is not set , will default to
     * {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean#setMetaArgumentsHandler(org.openspaces.remoting.MetaArgumentsHandler)}
     */
    String metaArgumentsHandler() default "";

    /**
     * Specifies the class name of a {@link org.openspaces.remoting.MetaArgumentsHandler} to be used to be used when invoking the
     * annotated method. When using this attribute, each invocation of the annotated method will result in creating
     * a new instance of the specified class. When the annotation is not set , will default to
     * {@link org.openspaces.remoting.EventDrivenSpaceRemotingProxyFactoryBean#setMetaArgumentsHandler(org.openspaces.remoting.MetaArgumentsHandler)}
     */
