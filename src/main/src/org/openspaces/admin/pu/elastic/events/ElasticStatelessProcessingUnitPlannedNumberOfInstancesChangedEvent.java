...
public class ElasticStatelessProcessingUnitPlannedNumberOfInstancesChangedEvent 
    ...
    */
    ...
    public ElasticStatelessProcessingUnitPlannedNumberOfInstancesChangedEvent(ProcessingUnit pu, int beforePlannedNumberOfInstances, int afterPlannedNumberOfInstances) {
