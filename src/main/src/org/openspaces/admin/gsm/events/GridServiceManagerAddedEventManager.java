...
/**
 * An event manager allowing to remove and add {@link GridServiceManagerAddedEventListener}s.
 *
 * @author kimchy
 */
public interface GridServiceManagerAddedEventManager {
     ...
     * managers as well.
     */
    void add(GridServiceManagerAddedEventListener eventListener, boolean includeExisting);
