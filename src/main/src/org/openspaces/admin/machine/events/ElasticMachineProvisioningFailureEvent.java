...
public class ElasticMachineProvisioningFailureEvent implements ElasticProcessingUnitFailureEvent {
     ...
     */
    public ElasticMachineProvisioningFailureEvent() {
    }
    
    public ElasticMachineProvisioningFailureEvent(String failureDescription, String[] processingUnitNames) {
