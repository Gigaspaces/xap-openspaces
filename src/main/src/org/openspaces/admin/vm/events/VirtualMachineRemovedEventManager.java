...
/**
 * An event manager allowing to remove and add {@link VirtualMachineRemovedEventListener}s.
 *
 * @author kimchy
 * @see org.openspaces.admin.vm.VirtualMachines#getVirtualMachineRemoved()
 */
