 ...
 * <p>If configured to use Fifo Grouping, the read/take operation will use {@link ReadModifiers#FIFO_GROUPING_POLL} / {@link TakeModifiers#FIFO_GROUPING_POLL} accordingly.
 * <ul><b>Note:</b> 
 * <li>All the handlers that uses the Fifo Grouping capability should be used with a template that uses Fifo Grouping </li>
 * <li>All the handlers that uses the Fifo Grouping capability must be performed under a transaction </li>
 * </ul>
 * @author yael
 * @since 9.0
 */
