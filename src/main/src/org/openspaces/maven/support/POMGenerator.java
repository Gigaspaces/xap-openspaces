...
public class POMGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        printDependency(writer, "org.springframework", "spring-aop", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-asm", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-aspects", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-beans", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-context", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-context-support", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-core", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-expression", "3.1.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-tx", "3.1.1.RELEASE");
