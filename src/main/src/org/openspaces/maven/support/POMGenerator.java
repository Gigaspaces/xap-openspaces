...
public class POMGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        printDependency(writer, "org.springframework", "spring-aop", "3.0.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-asm", "3.0.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-aspects", "3.0.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-beans", "3.0.1.RELEASE");
        printDependency(writer, "org.springframework", "spring-context", "3.0.1.RELEASE");
