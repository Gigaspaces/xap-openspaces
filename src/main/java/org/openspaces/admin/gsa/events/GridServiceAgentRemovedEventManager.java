...
/**
 * An event manager allowing to remove and add {@link GridServiceAgentRemovedEventListener}s.
 *
 * @author kimchy
 * @see org.openspaces.admin.gsa.GridServiceAgents#getGridServiceAgentRemoved() 
 */
