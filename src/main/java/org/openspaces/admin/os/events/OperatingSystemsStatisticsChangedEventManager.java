...
/**
 * An event manager allowing to add and remove {@link OperatingSystemsStatisticsChangedEventListener}.
 *
 * @author kimchy
 */
public interface OperatingSystemsStatisticsChangedEventManager {
     ...
     */
    void add(OperatingSystemsStatisticsChangedEventListener eventListener, boolean withHistory);
