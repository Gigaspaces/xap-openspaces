...
/**
 * An event manager allowing to remove and add {@link GridServiceManagerRemovedEventListener}s.
 *
 * @author kimchy
 * @see org.openspaces.admin.gsm.GridServiceManagers#getGridServiceManagerRemoved()
 */
