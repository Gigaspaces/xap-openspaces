...
public class DefaultGatewayRemovedEventManager implements InternalGatewayRemovedEventManager {
    ...
    private final List<GatewayRemovedEventListener> listeners = 
    						new CopyOnWriteArrayList<GatewayRemovedEventListener>();
    ...
    public void plus(Object eventListener) {
        if (GroovyHelper.isClosure(eventListener)) {
            add(new ClosureGatewayRemovedEventListener(eventListener));
        } else {
            add((GatewayRemovedEventListener) eventListener);
        }
    }
    ...
    public void minus(Object eventListener) {
        if (GroovyHelper.isClosure(eventListener)) {
            remove(new ClosureGatewayRemovedEventListener(eventListener));
        } else {
            remove((GatewayRemovedEventListener) eventListener);
        }
    }
