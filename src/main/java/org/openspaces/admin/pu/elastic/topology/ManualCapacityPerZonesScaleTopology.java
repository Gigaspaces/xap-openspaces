 ...
 * @since 9.1.0
 */
public interface ManualCapacityPerZonesScaleTopology {

    /**
     * Enables the specified scale strategy, and disables all other scale strategies.
     * Manual scale, starts containers with the specified GSA zones, until the specified capacity is reached. 
    ...
    ManualCapacityScaleTopology scale(
            ManualCapacityPerZonesScaleConfig strategy);
}
