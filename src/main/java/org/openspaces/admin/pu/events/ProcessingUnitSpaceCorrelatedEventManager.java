...
/**
 * An event manager allowing to add and remove {@link ProcessingUnitSpaceCorrelatedEventListener}s
 * in order to listen for {@link ProcessingUnitSpaceCorrelatedEvent}s.
 *
 * @author kimchy
 */
