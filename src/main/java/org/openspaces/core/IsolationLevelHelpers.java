...
public class IsolationLevelHelpers {
    ...
    /**
     * @param springIsolationLevel the spring isolation level as defined in {@link TransactionDefinition}.
     * @param defaultValue The modifiers to use in case springIsolationLevel equals 
     *        {@link TransactionDefinition#ISOLATION_DEFAULT}
     * @return A matcing GigaSpaces isolation level modifier.
     * @see {@link TransactionDefinition}, {@link ReadModifiers}, {@link CountModifiers}
     */
     ...
     * @return The merged modifiers (i.e, if there is a current transaction defined and it has a non default
