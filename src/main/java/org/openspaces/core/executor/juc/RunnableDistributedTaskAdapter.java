...
/**
 * An adapter allowing to execute a {@link Runnable} in a distributed fashion. In such a
...
public class RunnableDistributedTaskAdapter<T extends Serializable, R> extends RunnableTaskAdapter<T>
    ...
    /**
     * Constructs a new runnable distributed task adapter with a separate reducer. The reducer or the runnable
