...
/**
 * A {@link ColumnFamilyNameConverter} implementation that works as follows:
 * If the type names length does not exceed a 48 characters length, the dots in the type name
 * will be replaced by underscores.
 * Otherwise, the type simple name (without the packages prefix) will be used with the first 6 chars
 * of the string representation of the given type name MD5 hash to avoid name collisions.
