...
public class DefaultHibernateSpaceSynchronizationEndpoint extends AbstractHibernateSpaceSynchronizationEndpoint {
    ...
    /**
     * Perform the given transaction changes using Hibernate {@link org.hibernate.Session}.
     * <p/>
    ...
    /**
     * Perform the given batch changes using Hibernate {@link org.hibernate.Session}.
     * <p/>
     * <p>Note, this implementation relies on Hibernate {@link org.hibernate.NonUniqueObjectException} in case
     * the entity is already associated with the given session, and in such a case, will result in performing
     * merge operation (which is more expensive).
