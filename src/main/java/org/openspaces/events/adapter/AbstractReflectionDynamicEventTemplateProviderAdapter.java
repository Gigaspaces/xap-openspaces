 ...
 * 
 * <p>
 * Subclasses must implement the {@link #doGetListenerMethod()} in order to list the possible
...
InitializingBean, DynamicEventTemplateProvider {
    ...
    /**
     * @param failSilently - when set to true {@link #afterPropertiesSet()} will not raise an exception if an
     *  annotated method is not found.
     */
