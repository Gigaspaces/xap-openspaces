 ...
 * <p>If configured to use Memory Only Search, the read/take operation will use {@link ReadModifiers#MEMORY_ONLY_SEARCH} / {@link TakeModifiers#MEMORY_ONLY_SEARCH} accordingly.
 * @author eitany
 * @since 9.5
 */
public abstract class AbstractMemoryOnlySearchReceiveOperationHandler extends AbstractNonBlockingReceiveOperationHandler {
     ...
     * 
     * @param useMemoryOnlySearch if true, will use {@link ReadModifiers#MEMORY_ONLY_SEARCH} / {@link TakeModifiers#MEMORY_ONLY_SEARCH} as part of the read/take modifiers.
     */
