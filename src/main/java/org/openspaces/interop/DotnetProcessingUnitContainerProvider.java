 ...
 * @author kimchy
 */
public class DotnetProcessingUnitContainerProvider extends ProcessingUnitContainerProvider {

    public ProcessingUnitContainer createContainer() throws CannotCreateContainerException {
        return new DotnetProcessingUnitContainer(getClusterInfo(), getBeanLevelProperties());
    }
}
