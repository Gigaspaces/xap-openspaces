...
/**
 *
 * Override  {@link org.openspaces.esb.mule.transformers.OpenSpacesTransformer#getResultPayload(org.mule.umo.UMOMessage, String)}
 * in order to create as a ProcessedMessage as a result and transfer to it the metadata from the UMOMessage.
 *
 * @author yitzhaki
 */
