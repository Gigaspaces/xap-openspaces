...
public class ProcessRegistry {
    ...
    /**
     * Returns a reference to the the remote object Registry for the local host
    ...
    /**
     * Replaces the binding for the specified key in this registry with the
     * supplied remote reference. If there is an existing binding for the
     * specified name, it is discarded.
     * 
    ...
    /**
     * activates a watchdog watching over a registration. If lookup fails, will
     * issue a process termination.
     * 
     * @param key the name for the remote reference to look up.
     */
    ...
    /**
     * A watchdog task watching over a registration. If lookup fails, will
     * issue a process termination.
     */
