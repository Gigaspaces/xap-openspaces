...
public class Executor
{
  ...
  **/
   ...
   * @param dir The directory to execute the command from or <code>null</code> to to have current directory.
 ...
 /**
  * Redirect process output stream to desired abstract {@link OutputStream} (FileOutputStream, System.out).
  *  
