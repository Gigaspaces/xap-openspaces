 ...
 * All class methods provides ability to add/remove dynamically the desired jar/class-directory/zip.
 * To inherit all classpath from running JVM use {@link #inherit()} method.
 * 
 * Example usage:
 * <pre>
...
public class ClassPath
{
     ...
     * 
     * @param classpath the classpath with path separator. Separator can be ; or :
     * For example: /usr/lib/mylib1.jar:/usr/lib/mylib2.jar:/usr/lib/mylib3.jar
     */
