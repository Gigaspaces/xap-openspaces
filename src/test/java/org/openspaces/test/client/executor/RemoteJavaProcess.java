...
/**
 * RemoteJavaProcess provides server peer of {@link RemoteJavaCommand} and manages the lifecycle of forked JVM.<br>
 * All remote methods received from client peer {@link RemoteJavaCommand} will be invoked 
 * on user-defined impl-class {@link #getTargetInvObject()}.<br>
 * {@link RemoteJavaProcess} inherits WatchDog capabilities from JavaProcess, if parent JVM was destroyed, the RemoteJavaProcess
 * will be destroyed as well by WatchDog.
 * 
...
implements InternalRemoteJavaProcessProtocol
{
    ...
    /**
     * Received remote method from client peer {@link RemoteJavaCommand} to invoke on {@link #getTargetInvObject()} object.
     * 
     * @see java.lang.reflect.InternalRemoteJavaProcessProtocol#invoke(java.lang.Object, java.lang.reflect.Method, java.lang.Object[])
     */
    @SuppressWarnings("rawtypes")
    ...
    /**
     * binds the process to the registry.
     * <p>
     * Note: doesn't call the process main method! Only the public no-args
     * constructor is called, as would be expected from a regular class
     * invoked remotely.
     */
    @Override
    ...
    /**
     * Returns stub of this class. This stub will be registered to RMIRegistry of {@link RemoteJavaCommand}.
     * 
     * @throws RemoteException Failed to export {@link RemoteJavaProcess} to stub.
     * @see org.openspaces.test.client.executor.JavaProcess#getProcessStub(java.rmi.registry.Registry, java.lang.String)
     */
    @Override
