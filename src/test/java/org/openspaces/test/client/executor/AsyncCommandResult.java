 ...
 * <li>redirect process stream to desired {@link OutputStream} or to file.</li>
 *
		...
		extends CommandResult
{
	 ...
	 * @throws FileNotFoundException Failed to initialize output file, file path is wrong or permission denied.
	...
	/**
	 * Redirect process stream to supplied output stream, i.e : {@link System#out}, {@link FileOutputStream}, {@link BufferedOutputStream}
