package org.openspaces.itest.core.space.embedded;
...
@ContextConfiguration("classpath:/org/openspaces/itest/core/space/embedded/embedded.xml")
public class EmbeddedSpaceTest {
    @Autowired
    protected ApplicationContext applicationContext;

    protected String[] getConfigLocations() {
        return new String[]{"/org/openspaces/itest/core/space/embedded/embedded.xml"};
    }
