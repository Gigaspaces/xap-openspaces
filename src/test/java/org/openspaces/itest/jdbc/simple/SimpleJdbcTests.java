...
@ContextConfiguration("classpath:/org/openspaces/itest/jdbc/simple/jdbc.xml")
public class SimpleJdbcTests  extends AbstractTransactionalJUnit4SpringContextTests {
