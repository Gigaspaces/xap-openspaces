...
package org.openspaces.itest.events.polling.aspectlistener;
...
@ContextConfiguration("classpath:/org/openspaces/itest/events/polling/aspectlistener/aspect-listener.xml")
public class AspectListenerPollingContainerTests   { 
    ...
    public AspectListenerPollingContainerTests() {
    ...
    protected String[] getConfigLocations() {
        return new String[]{"/org/openspaces/itest/events/polling/aspectlistener/aspect-listener.xml"};
    }
