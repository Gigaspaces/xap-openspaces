...
package was already executed, it can be omitted). Running a specific module with a cluster
topology can be executed using: mvn pacakge os:run-standalone -Dmodule=processor -Dcluster="total_members=2,1".
