...
REM GigaSpaces Jars
call mvn install:install-file -DgroupId=com.gigaspaces -DcreateChecksum=true -DartifactId=gs-runtime -Dversion=%XAP_VERSION% -DpomFile=%JSHOMEDIR%/tools/maven/poms/gs-runtime/pom.xml -Dpackaging=jar -Dfile="%JSHOMEDIR%/lib/required/gs-runtime.jar"
call mvn install:install-file -DgroupId=com.gigaspaces -DcreateChecksum=true -DartifactId=gs-openspaces -Dversion=%XAP_VERSION% -DpomFile=%JSHOMEDIR%/tools/maven/poms/gs-openspaces/pom.xml -Dpackaging=jar -Dfile="%JSHOMEDIR%/lib/required/gs-openspaces.jar" -Dsources="%JSHOMEDIR%/lib/optional/openspaces/gs-openspaces-sources.jar"
